      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold text-white">Course Store</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/#courses" className="hover:text-blue-400 transition-colors text-sm">
                  All Courses
                </Link>
              </li>
              <li>
                <Link href="/my-courses" className="hover:text-blue-400 transition-colors text-sm">
                  My Courses
                </Link>
              </li>
              <li>
                <Link href="/dashboard" className="hover:text-blue-400 transition-colors text-sm">
                  Dashboard
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li className="hover:text-blue-400 transition-colors cursor-pointer">Data Science</li>
              <li className="hover:text-blue-400 transition-colors cursor-pointer">Mobile Development</li>
        ...
        <div className="pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-gray-400">
              © {currentYear} Course Store. All rights reserved.
            </p>
            <div className="flex items-center gap-6 text-sm">
              <span className="text-gray-400">Made with ❤️ for learners</span>
            </div>
          </div>
        </div>
      </div>
