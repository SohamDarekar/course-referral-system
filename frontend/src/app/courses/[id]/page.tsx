      ...
      <>
        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 py-12 px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl p-8 animate-pulse">
              <div className="h-10 bg-gray-200 dark:bg-gray-700 rounded mb-4 w-3/4" />
              <div className="h-6 bg-gray-200 dark:bg-gray-700 rounded mb-8 w-1/2" />
              ...
              <div className="bg-gradient-to-r from-blue-600 to-indigo-600 px-8 py-12 text-white">
                ...
                <div className="flex items-center gap-6 flex-wrap">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-lg">{course.courseHours} hours</span>
                  </div>
                  <div className="px-4 py-1 bg-white/20 rounded-full text-sm font-medium">
                    {course.level}
                  </div>
                </div>
              </div>

              <div className="px-8 py-6 bg-gray-50 dark:bg-gray-900/50 flex items-center justify-between">
                ...
                >
                  ...
                  {isPurchased ? (
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="border-2 border-blue-500 dark:border-blue-600 rounded-lg p-6 bg-blue-50/50 dark:bg-blue-900/10">
                        <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">
                          Buy with Credits
                        </h3>
