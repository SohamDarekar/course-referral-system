    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 py-12 px-4 sm:px-6 lg:px-8 transition-colors">
        <div className="max-w-7xl mx-auto">
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-4xl font-bold text-primary-600 dark:text-primary-400">{stats.totalReferredUsers}</p>
                </div>
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-4xl font-bold text-green-600 dark:text-green-400">{stats.convertedUsers}</p>
                </div>
                <div className="text-5xl">✅</div>
              </div>
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-4">
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-4xl font-bold text-purple-600 dark:text-purple-400">{stats.totalCreditsEarned}</p>
                </div>
                <div className="text-5xl">💎</div>
              </div>
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-4">
          ...
          >
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Your Referral Link</h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <input
                ...
                className="flex-1 px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-md bg-gray-50 dark:bg-gray-700 text-gray-700 dark:text-gray-300 font-mono text-sm"
              />
              <motion.button
